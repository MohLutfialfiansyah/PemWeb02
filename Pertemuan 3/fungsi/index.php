            ...
            <form class="mt-4" method="POST" action="hasil.php">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nilai_uts" name="uts" placeholder="Nilai UTS" type="number" class="form-control" required>
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nilai_uas" name="uas" placeholder="Nilai UAS" type="number" class="form-control" required>
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nilai_tugas" name="tugas" placeholder="Nilai Tugas" type="number" class="form-control" required>
                    </div>
                    </div>
                </div> 
                <div class="form-group row">
